...
export default function ReportsPage() {
  ...
  const handleDeleteAllDataExceptCreditors = (): void => {
    showModal({
      ...
      message:
        "Are you sure you want to delete ALL data except creditors? This will remove all sales, expenses, and payments permanently but keep creditors intact.",
      type: "confirm",
      ...
      <header style={headerStyles}>
        <div style={headerContentStyles}>
          ...
          <div style={headerButtonsStyle}>
            <button
              onClick={handleDeleteAllDataExceptCreditors}
      ...
      <div style={contentStyles}>
        ...
        <div style={sectionStyles}>
          <h2 style={sectionTitleStyle}>
            Sales Report - All Entries ({data.sales.length})
          </h2>
        ...
        <div style={sectionStyles}>
          <h2 style={sectionTitleStyle}>
            Expenses Report ({data.expenses.length})
          </h2>
          <div style={tableContainerStyles}>
            <table style={tableStyles}>
              <thead>
        ...
        <div style={sectionStyles}>
          <h2 style={sectionTitleStyle}>
            Creditors Report ({data.creditors.length})
          </h2>
          <div style={tableContainerStyles}>
            <table style={tableStyles}>
              <thead>
        ...
        <div style={sectionStyles}>
          <h2 style={sectionTitleStyle}>
            Payments Report ({data.payments.length})
          </h2>
          <div style={tableContainerStyles}>
            <table style={tableStyles}>
              <thead>
